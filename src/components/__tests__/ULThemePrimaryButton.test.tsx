...
describe('ULThemePrimaryButton', () => {
  ...
  it('matches snapshot with default props', () => {
    const { container } = render(<ULThemePrimaryButton>Default Button</ULThemePrimaryButton>);
  ...
  it('matches snapshot with custom className', () => {
    const { container } = render(
      <ULThemePrimaryButton className="w-full custom-btn">Full Width Button</ULThemePrimaryButton>
    );
    expect(container.firstChild).toMatchSnapshot();
  });
  ...
  it('applies theme classes correctly', () => {
    render(<ULThemePrimaryButton data-testid="themed-button">Themed</ULThemePrimaryButton>);
  ...
  it('supports custom className', () => {
    render(
      <ULThemePrimaryButton className="custom-class" data-testid="custom-button">
        Custom
      </ULThemePrimaryButton>
    );
  ...
  it('applies Auth0 theme utility classes', () => {
    render(<ULThemePrimaryButton data-testid="auth0-button">Auth0 Themed</ULThemePrimaryButton>);
